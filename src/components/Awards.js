...
const AwardsTable = [
    ...
    { key:"CHCHCH", award: 10 },
    { key:"B1CHCH", award: 10 },  { key:"LMT7T7", award: 20 },
    ...
    { key:"O7B3O7", award: 20 }, { key:"B3O7O7", award: 20 },  
    ...
    { key:"B3T7B3", award: 50 }, { key:"CHB3CH", award: 20 },
    ...
    { key:"T7T7B3", award: 35 }, { key:"B3O7B3", award: 30 },
    ...
    { key:"O7B3O7", award: 60 }, { key:"O7O7T7", award: 80 },
    { key:"B1B2O7", award: 30 },  { key:"O7B3T7", award: 60 },
    { key:"B2B1T7", award: 40 }, { key:"B2B3T7", award: 40 },
    { key:"B3O7B1", award: 40 }, { key:"O7B1B1", award: 40 },
    { key:"B3B2T7", award: 40 }, { key:"T7B2B2", award: 40 },
    { key:"B2O7T7", award: 50 }, { key:"T7O7B2", award: 50 },
    { key:"B3B1B2", award: 30 }, { key:"T7CHO7", award: 20 },
    { key:"O7OLO7", award: 30 }, { key:"LMO7O7", award: 20 },
    { key:"T7T7OR", award: 10 }, { key:"B3T7T7", award: 60 },
